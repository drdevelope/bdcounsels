  ...
  return (
    <div className="flex-1 bg-gradient-to-br from-rose-50 via-blue-50 to-indigo-50 min-h-screen overflow-y-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 mb-8 lg:mb-12 -mt-50px">
        ...
        {/* NEET PG 2024 vs 2025 Statistics - Mobile Optimized */}
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl lg:rounded-3xl shadow-xl p-6 lg:p-8 mb-8 lg:mb-12 border border-white/20">
          <div className="text-center mb-6 lg:mb-8">
            ...
            <p className="text-slate-600 text-sm lg:text-base">
              The NEET PG cutoff for 2025 is expected to be similar to the previous year cutoff ranks. The cutoff score for General is expected to range 275-320 marks, while for SC/ST/OBC a score between 245-275 is expected.
            </p>
          </div>

          <div className="text-center mb-6 lg:mb-8">
            <h3 className="text-xl lg:text-2xl font-bold text-slate-800 mb-2">
              What is the latest cutoff for NEET PG?
            </h3>
            <table className="w-full text-left border-collapse">
              <thead>
          <tr>
            <th className="border-b border-slate-200 py-2 text-slate-600 text-sm lg:text-base">Category</th>
            <th className="border-b border-slate-200 py-2 text-slate-600 text-sm lg:text-base">Expected Qualifying Percentile</th>
            <th className="border-b border-slate-200 py-2 text-slate-600 text-sm lg:text-base">Estimated Score Range (Out of 800)</th>
          </tr>
              </thead>
              <tbody>
          <tr>
